...
description: "Use ONLY when working on animations, transitions, easing curves, spring physics, micro-interactions, motion design, gesture interactions, or the polish/feel of interactive elements. Encodes Emil Kowalski's (Sonner/Vaul author, ex-Vercel/Linear) motion design philosophy. Do NOT use for general UI design, color systems, typography, layouts, or component composition — use frontend-design or ui-ux-pro-max for those."
---
