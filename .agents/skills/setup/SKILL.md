---
name: setup
description: Bootstrap a new project. Runs a structured discovery interview, then generates the .ai/context docs (TECH_STACK, GLOSSARY, PRD, APP_FLOW, ROADMAP, DESIGN_SYSTEM). Invoke explicitly ($setup / /setup) before coding begins on a greenfield project.
---
